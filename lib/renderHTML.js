...
const renderManager = manager => {
  let htmlEl = fs.readFileSync(path.resolve(htmlDir, "manager.html"), "utf8");
...
const renderMain = html => {
  const htmlEl = fs.readFileSync(path.resolve(htmlDir, "main.html"), "utf8");
  return replacePlaceholders(htmlEl, "team", html);
};
